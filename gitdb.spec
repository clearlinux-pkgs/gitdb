...
#
# Source0 file verified with key 0x85194C08421980C9 (byronimo@gmail.com)
#
Name     : gitdb
Version  : 4.0.7
Release  : 21
...
Source0  : https://files.pythonhosted.org/packages/34/fe/9265459642ab6e29afe734479f94385870e8702e7f892270ed6e52dd15bf/gitdb-4.0.7.tar.gz
Source1  : https://files.pythonhosted.org/packages/34/fe/9265459642ab6e29afe734479f94385870e8702e7f892270ed6e52dd15bf/gitdb-4.0.7.tar.gz.asc
...
%prep
%setup -q -n gitdb-4.0.7
cd %{_builddir}/gitdb-4.0.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617043088
...
cp %{_builddir}/gitdb-4.0.7/LICENSE %{buildroot}/usr/share/package-licenses/gitdb/338a160e1cc55e2722d66d2eb5e78b149763f1f6
