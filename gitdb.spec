...
Source0  : https://files.pythonhosted.org/packages/b6/7b/e373bd7e93a5b4bb041b44601fbb96c7029033d6e838e0a6936fe4f25275/gitdb-4.0.6.tar.gz
...
%prep
%setup -q -n gitdb-4.0.6
cd %{_builddir}/gitdb-4.0.6
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1616685810
...
cp %{_builddir}/gitdb-4.0.6/LICENSE %{buildroot}/usr/share/package-licenses/gitdb/338a160e1cc55e2722d66d2eb5e78b149763f1f6
