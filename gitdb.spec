...
Source0  : https://files.pythonhosted.org/packages/bc/f2/a2191834e7f9bb34ff14a0c2db90d2bf8510cf74fa395544c9f10731dc25/gitdb-4.0.4.tar.gz
...
%prep
%setup -q -n gitdb-4.0.4
cd %{_builddir}/gitdb-4.0.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1587074163
...
cp %{_builddir}/gitdb-4.0.4/LICENSE %{buildroot}/usr/share/package-licenses/gitdb/338a160e1cc55e2722d66d2eb5e78b149763f1f6
